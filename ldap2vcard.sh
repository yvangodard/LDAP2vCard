...
help () {
	...
	echo -e "\t-D <main damain for emails>:      will mark addresses containing this domain as 'TYPE=PREF' in vCard (i.e.: 'mydomain.fr')"
	...
	echo -e "\t-P <Path folder to export>:       the folder where your want to export your vCard (i.e.: '~/Deskotp/' or '/var/vcard/'...), by default ${PATH_EXPORT_VCARD}"
